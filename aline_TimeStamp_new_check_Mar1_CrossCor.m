...
% current path_seg
path_seg = 'nas207-3\Data\from pc207-15\laura\20-07-10\';
...
name_temp = 'egl-17 (e1313)X on food R_2010_07_20__15_34_32___2___11';
...
%                 end
            ...
            if size(strfind(maindir_thecus, 'nas207-3'),1)>0
                save([root,'.data\',temp_text_file], 'nf','diff_mask_central', 'min_fra_ind_match','hdf5_path'); 
            else
